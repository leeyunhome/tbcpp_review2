// 18_4 stream states input validation.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	//	////cin.rdstate() == std::istream::goodbit; // 이렇게 추출할 수도 있다.
